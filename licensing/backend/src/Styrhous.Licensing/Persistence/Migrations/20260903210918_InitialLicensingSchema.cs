        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_billing_webhook_events_publication", "last_published_at IS NULL OR last_published_at >= received_at");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    xml = table.Column<string>(type: "character varying(65536)", maxLength: 65536, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_identity_users_user_account_id",
                        column: x => x.id,
                        principalTable: "user_accounts",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_billing_operations_lifecycle", "(kind = 'InitialCheckout' AND expires_at IS NOT NULL AND provider_mutation_replay_started_at IS NULL AND seat_quantity_outcome IS NULL AND ((status = 'Pending' AND provider_session_recorded_at IS NULL AND external_session_id IS NULL AND closed_at IS NULL) OR (status = 'ProviderSessionCreated' AND provider_session_recorded_at IS NOT NULL AND external_session_id IS NOT NULL AND closed_at IS NULL) OR (status = 'Completed' AND provider_session_recorded_at IS NOT NULL AND external_session_id IS NOT NULL AND closed_at IS NOT NULL) OR (status = 'Failed' AND provider_session_recorded_at IS NULL AND external_session_id IS NULL AND closed_at IS NOT NULL) OR (status = 'Expired' AND provider_session_recorded_at IS NOT NULL AND external_session_id IS NOT NULL AND closed_at IS NOT NULL))) OR (kind = 'SeatQuantityChange' AND expires_at IS NULL AND provider_session_recorded_at IS NULL AND external_session_id IS NULL AND ((status = 'Pending' AND closed_at IS NULL AND seat_quantity_outcome IS NULL) OR (status = 'Completed' AND closed_at IS NOT NULL AND seat_quantity_outcome = 'Applied') OR (status = 'Failed' AND closed_at IS NOT NULL AND seat_quantity_outcome IN ('Superseded', 'ProviderRejected'))))");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_identity_user_claims_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_identity_user_logins_user_id",
                        column: x => x.user_id,
                        principalTable: "identity_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_identity_user_tokens_user_id",
                        column: x => x.user_id,
                        principalTable: "identity_users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
