...
const DISCOVERY_ACTION_COLUMN_WIDTH: f32 = 161.0;
...
use discovery_table::*;
pub(super) use licensing::LicenseSettingsBlade;
pub(super) use namespace_selector::NamespaceSelectorSettingsBlade;
